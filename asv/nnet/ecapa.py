...
class AAMsoftmax(nn.Module):
    ...
    def forward(self, x, label=None):
        ...
        prec = accuracy(output.detach(), label.detach(), topk=(1,))[0]
        return loss, prec
...
class SVModel(nn.Module):
    def __init__(self,
                 ...
                 aam_softmax: AAMsoftmax,):
        super().__init__()
        self.specaug = FbankAug() # Spec augmentation
        self.speaker_encoder = ecapa_tdnn
        self.speaker_loss = aam_softmax
    ...
    def forward(self,
        ...
        '''
            ...
            labels: B, 1
        '''
        speech = self.specaug(speech.permute(0,2,1))
        speaker_embedding = self.speaker_encoder.forward(speech)
        loss, prec = self.speaker_loss.forward(speaker_embedding, labels)
        return loss, prec
